...
<nav class="side-menu">
    ...
    <ul class="side-menu-list">
            ...
            <li class="nav-item">
                <a class="side-menu-link" href="#">About</a>
            </li>
            <li class="nav-item">
                <a class="side-menu-link" href="#">Services</a>
            </li>
            <li class="nav-item">
                <a class="side-menu-link" href="#">Portfolio</a>
            </li>
            <li class="nav-item">
                <a class="side-menu-link" href="#">Contact</a>
            </li>
...
<section  class='yellow'>
    <div class="container-fluid flex">
        <div class='title'>
            <h1 class='helo'>PostAlfa</h1>
            <h2><I>Sveiki atvykę!</I></h2>
